...
<body>
	...
	<div class="w3-top">
		<div class="w3-bar w3-black w3-card-2">
			...
			<c:choose>
				<c:when test="${empty sessionScope.memberid.value }">
			<a href="login.jsp"
				class="w3-bar-item w3-button w3-padding-large w3-hide-small">로그인</a>
			</c:when>
				<c:when test="${sessionScope.memberid.value }">
			<a href="logout.jsp"
				class="w3-bar-item w3-button w3-padding-large w3-hide-small">로그아웃</a>
				</c:when>
			</c:choose>
			<a href="member_list.jsp"
				class="w3-bar-item w3-button w3-padding-large w3-hide-small">회원
				리스트</a> <a href="join.jsp"
				class="w3-bar-item w3-button w3-padding-large w3-hide-small">회원가입</a>
			<a href="bbs_form.jsp"
				class="w3-bar-item w3-button w3-padding-large w3-hide-small">글쓰기</a>
			<a href="bbs_list.jsp"
				class="w3-bar-item w3-button w3-padding-large w3-hide-small">게시판</a>
	...
	<div id="navDemo"
		...
		<a href="member_list.jsp"
			class="w3-bar-item w3-button w3-padding-large">회원리스트</a> <a
			href="bbs_list.jsp" class="w3-bar-item w3-button w3-padding-large">게시판</a>
